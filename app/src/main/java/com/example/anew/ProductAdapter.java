...
public class ProductAdapter extends CursorAdapter {
    ...
    public ProductAdapter(ProductDisplay context, Cursor cursor, int flags) {
        super(context, cursor, flags);
    }

    public ProductAdapter(ViewProductActivity viewProductActivity, Cursor cursor, int flags) {
        super(viewProductActivity, cursor, flags);
    }
