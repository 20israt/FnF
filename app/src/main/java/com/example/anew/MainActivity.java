    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(v->{
            ...
            if (username.isEmpty() || password.isEmpty()) {
                ...
                if(username.equals("israt") && password.equals("israt")){
                    ...
                    if(result){
                        ...
                        Intent intent = new Intent(MainActivity.this, ProductDisplay.class); // Assuming HomeActivity is the activity after login
                        startActivity(intent);
                    }else{
